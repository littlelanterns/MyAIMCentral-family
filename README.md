...
├── audit/                             ← PRD compliance audit (architectural rigor)
├── docs/
...
- **[docs/FOUNDER_STORY.md](docs/FOUNDER_STORY.md)** — The person behind the platform
- **[docs/THE_LANTERNS_WE_LIVE_BY.md](docs/THE_LANTERNS_WE_LIVE_BY.md)** — Mission and values
- **[docs/research/MARKET_RESEARCH.md](docs/research/MARKET_RESEARCH.md)** — Market opportunity and ESA landscape

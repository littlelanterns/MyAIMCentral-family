...
>
> **Pending function-only migrations (not yet applied):** 100207 (`execute_allowance_godmother`, upgraded `dispatch_godmothers`), 100208 (`execute_numerator_godmother`), 100209 (`grant_money`, `execute_money_godmother`), 100210 (`grant_points`, `execute_points_godmother`). No new tables or columns. Run `npm run schema:dump` after applying to refresh this file.

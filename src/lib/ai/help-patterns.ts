...
const HELP_PATTERNS: HelpPattern[] = [
  ...
  {
    category: 'meetings',
    keywords: ['touch base', 'meeting', 'couple meeting', 'family meeting', 'family council', 'parent child meeting', 'mentor meeting', 'conversation topics', 'things to talk about'],
    response: "Go to **Touch Base** in the sidebar (under Plan & Do).\n\nTouch Base keeps a running list of things you want to talk about with anyone — your spouse, each kid, the whole family, or outside contacts.\n\n**The simple way:** Expand a card, add items, and check them off as you discuss them. No formal meeting needed.\n\n**Notes:** Tap \"Notes\" to jot down decisions or follow-ups during a conversation. Save to Journal when done.\n\n**Formal meetings (optional):** Tap \"Formal Meeting\" when you want LiLa to facilitate with guided sections, post-meeting review, and action item extraction.\n\n**Custom conversations:** Tap \"Add a Conversation\" for IEP prep, parent-teacher notes, homeschool coordinator questions, or personal reflection.",
  },
  {
    category: 'meetings',
    keywords: ['agenda item', 'add agenda', 'meeting agenda', 'things to discuss', 'things to bring up'],
    response: "You can add things to talk about at any time:\n\n1. **From Touch Base**: Expand a card and type in the \"+ Add agenda item\" field\n2. **From Smart Notepad**: Write your thought, then tap **Send to** > **Agenda** — pick which conversation it belongs to\n3. **From Review & Route**: Route extracted items to Agenda\n4. **From MindSweep**: Brain dump items classified as agenda topics land in your queue — pick which conversation\n\nItems stay on the card until you check them off. Undiscussed items carry forward naturally.",
  },
  {
    category: 'meetings',
    keywords: ['meeting history', 'past meetings', 'conversation history', 'meeting summary', 'meeting notes', 'what did we discuss'],
    response: "Go to **Touch Base** and scroll to **Recent History**. Tap **View All** to search past conversations by title or summary.\n\nEach completed session saves:\n- A summary (generated by LiLa, editable by you)\n- Action items that were routed to Tasks, Calendar, etc.\n- Notes saved to your **Journal** as meeting notes\n\nYou can search by keyword to find what was discussed on a specific topic.",
  },
  {
    category: 'meetings',

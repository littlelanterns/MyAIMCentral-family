...
const HELP_PATTERNS: HelpPattern[] = [
  ...
  {
    category: 'meetings',
    keywords: ['set up meetings', 'schedule meetings for family', 'meeting wizard', '1:1 time', 'one on one', 'date with kid', 'date with child', 'parent child date', 'birthday date meeting', 'alternate parents'],
    response: "The **Family Meeting Setup** wizard schedules everything at once:\n\n1. Go to **Studio** > **Setup Wizards** > **Family Meeting Setup**, or visit the **Meetings** page when no schedules exist yet\n2. **Family Council**: Pick a day (like Sunday) — the whole family participates, and kids can add their own agenda items\n3. **1:1 Time with each child**: Select your kids, pick timing (their birthday date each month, a specific day, or an ordinal weekday like \"3rd Friday\"), choose labels (\"Date,\" \"Check-in,\" \"Mentor Meeting,\" etc.)\n4. **Alternate with your partner**: If you have a partner, choose to alternate months so each parent gets their own 1:1 time\n5. **Couple check-in**: Weekly or biweekly with your partner\n6. Review everything and confirm — all schedules + calendar events are created in one tap\n\nYou can always change any schedule later from the Meetings page.",
  },
]

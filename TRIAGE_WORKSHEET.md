...
| 40 | NEW-P | Tracker | Medium | N |  | Fix Next Build | **HELD** — PRD home pending founder call (PRD-28 vs PRD-10; homeschool_time_logs precedent argues PRD-28) |  |  | Reading Tracker primitive (separate from BookShelf; general reading log, all-role log entries) — _Doc §1.1 + draft note 18. PRD-28 or PRD-10 addendum._ |

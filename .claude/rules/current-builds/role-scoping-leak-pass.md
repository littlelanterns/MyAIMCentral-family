...
| Automated test pin for scoping rules | follow-up doc Worker 1 tests | **Stubbed** | Not added this session — flagged as residual; founder eyes-on is the verification layer for this pass. |

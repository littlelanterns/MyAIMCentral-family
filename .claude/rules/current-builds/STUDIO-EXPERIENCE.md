...
> **Status: ST-A CODE COMPLETE + PINS GREEN (14/14 E2E + 25 vitest + 8/8 relevant regressions, 2026-08-23) — HOLDING for founder review + commit approval. NOTHING COMMITTED.** See "## ST-A — Shelf truth" section below for the full record, migrations taken (100317 + 100318, applied to production + ledger-repaired), and the two adjacent dead-write-path discoveries. Next slice after sign-off: ST-F.
